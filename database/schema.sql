-- ============================================================
-- MARTEX DATABASE SCHEMA (Compatible al 100% con MySQL Workbench)
-- Arquitectura de Base de Datos para Uniformes Médicos y de Belleza
-- ============================================================
...
-- Deshabilitar llaves foráneas temporalmente para evitar problemas de regeneración
...
-- ============================================================
-- TABLA: medidas (Especializada para Filipina/Gabacha y Pantalón)
-- ============================================================
